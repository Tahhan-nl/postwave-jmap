<?php
/**
 * Tahhan JMAP Mailer admin page template — v3 Professional
  ...
  <div class="pw-wizard__card">
    ...
    <div class="pw-wizard__body">
      ...
      <div class="pw-wizard__step pw-wizard__step--active">
        <p style="font-size:15px;color:#374151;margin:0 0 20px;"><?php esc_html_e( 'Send every WordPress email through your own JMAP mail server — no SMTP ports, no relay limits.', 'tahhan-jmap-mailer' ); ?></p>
        <ul style="list-style:none;padding:0;margin:0 0 24px;display:flex;flex-direction:column;gap:12px;">
          <li style="display:flex;align-items:flex-start;gap:10px;">
            ...
            <span style="font-size:13px;color:#374151;"><?php esc_html_e( 'RFC 8620/8621 — works with Stalwart, Fastmail &amp; more', 'tahhan-jmap-mailer' ); ?></span>
          </li>
          <li style="display:flex;align-items:flex-start;gap:10px;">
            <svg viewBox="0 0 20 20" fill="#6366f1" width="18" height="18" style="flex-shrink:0;margin-top:2px;"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/></svg>
            <span style="font-size:13px;color:#374151;"><?php esc_html_e( 'Multi-account routing — send order emails from a dedicated address', 'tahhan-jmap-mailer' ); ?></span>
          </li>
          <li style="display:flex;align-items:flex-start;gap:10px;">
            <svg viewBox="0 0 20 20" fill="#6366f1" width="18" height="18" style="flex-shrink:0;margin-top:2px;"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/></svg>
            <span style="font-size:13px;color:#374151;"><?php esc_html_e( 'Retry queue, open tracking, and full mail log included', 'tahhan-jmap-mailer' ); ?></span>
          </li>
        </ul>
        <div class="pw-wizard__actions">
          <a href="<?php echo esc_url( add_query_arg( 'skip_wizard', '1', admin_url( 'admin.php?page=postwave' ) ) ); ?>" class="pw-wizard__btn pw-wizard__btn--ghost"><?php esc_html_e( 'Skip for now', 'tahhan-jmap-mailer' ); ?></a>
          <button type="button" class="pw-wizard__btn pw-wizard__btn--primary" data-wizard-next="1"><?php esc_html_e( 'Get Started', 'tahhan-jmap-mailer' ); ?> &rarr;</button>
        </div>
      </div>
      ...
      <div class="pw-wizard__step">
        <form method="post" action="<?php echo $act; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>" id="pw-wz-form">
          ...
          <div class="pw-wizard__field">
            <label for="pw-wz-url"><?php esc_html_e( 'Server URL', 'tahhan-jmap-mailer' ); ?></label>
            ...
            <span style="font-size:12px;color:#6b7280;margin-top:4px;display:block;"><?php esc_html_e( 'JMAP session is auto-discovered at /.well-known/jmap', 'tahhan-jmap-mailer' ); ?></span>
          </div>
          <div class="pw-wizard__field">
            <label for="pw-wz-user"><?php esc_html_e( 'Username', 'tahhan-jmap-mailer' ); ?></label>
            <input type="text" id="pw-wz-user" name="postwave[username]"
              value="<?php echo esc_attr( $o( 'username' ) ); ?>" autocomplete="username" required>
          </div>
          <div class="pw-wizard__field">
            <label for="pw-wz-pass"><?php esc_html_e( 'Password', 'tahhan-jmap-mailer' ); ?></label>
            <input type="password" id="pw-wz-pass" name="postwave[password]" autocomplete="new-password">
          </div>
          <div class="pw-wizard__actions">
            <button type="button" class="pw-wizard__btn pw-wizard__btn--ghost" data-wizard-next="0">&larr; <?php esc_html_e( 'Back', 'tahhan-jmap-mailer' ); ?></button>
            <button type="button" class="pw-wizard__btn pw-wizard__btn--primary" data-wizard-next="2"><?php esc_html_e( 'Test &amp; Continue', 'tahhan-jmap-mailer' ); ?> &rarr;</button>
          </div>
        </form>
      </div>
      ...
      <div class="pw-wizard__step">
        <div class="pw-wizard__field">
          <label for="pw-wz-iname"><?php esc_html_e( 'Identity Name', 'tahhan-jmap-mailer' ); ?></label>
          <input type="text" id="pw-wz-iname" name="postwave[identity_name]"
            value="<?php echo esc_attr( $o( 'identity_name', get_bloginfo( 'name' ) ) ); ?>">
        </div>
        <div class="pw-wizard__field">
          <label for="pw-wz-iemail"><?php esc_html_e( 'Identity Email', 'tahhan-jmap-mailer' ); ?></label>
        ...
        <div class="pw-wizard__field">
          <label for="pw-wz-iid"><?php esc_html_e( 'Identity ID', 'tahhan-jmap-mailer' ); ?> <span style="font-size:11px;color:#9ca3af;"><?php esc_html_e( 'optional — leave blank to auto-resolve', 'tahhan-jmap-mailer' ); ?></span></label>
          <input type="text" id="pw-wz-iid" name="postwave[identity_id]"
            value="<?php echo esc_attr( $o( 'identity_id' ) ); ?>"
            placeholder="<?php esc_attr_e( 'Auto-resolve from server', 'tahhan-jmap-mailer' ); ?>">
        </div>
        <div class="pw-wizard__actions">
          <button type="button" class="pw-wizard__btn pw-wizard__btn--ghost" data-wizard-next="1">&larr; <?php esc_html_e( 'Back', 'tahhan-jmap-mailer' ); ?></button>
          <button type="button" class="pw-wizard__btn pw-wizard__btn--primary" data-wizard-next="3"><?php esc_html_e( 'Save &amp; Continue', 'tahhan-jmap-mailer' ); ?> &rarr;</button>
        </div>
      </div>
      ...
      <div class="pw-wizard__step">
        <div class="pw-wizard__success">
          ...
          <h2 style="font-size:20px;font-weight:700;color:#1d2327;margin:0 0 8px;"><?php esc_html_e( 'Tahhan JMAP Mailer is ready!', 'tahhan-jmap-mailer' ); ?></h2>
          <p style="font-size:14px;color:#6b7280;margin:0 0 20px;"><?php esc_html_e( 'Your JMAP server is configured. Enable Tahhan JMAP Mailer on the General tab to start routing emails.', 'tahhan-jmap-mailer' ); ?></p>
          <ul style="list-style:none;padding:0;margin:0 0 24px;text-align:left;display:inline-block;">
            <li style="font-size:13px;color:#374151;margin-bottom:8px;">&#10003; <?php esc_html_e( 'Server connected', 'tahhan-jmap-mailer' ); ?></li>
            <li style="font-size:13px;color:#374151;margin-bottom:8px;">&#10003; <?php esc_html_e( 'Identity configured', 'tahhan-jmap-mailer' ); ?></li>
            <li style="font-size:13px;color:#374151;">&#10003; <?php esc_html_e( 'Ready to send', 'tahhan-jmap-mailer' ); ?></li>
          </ul>
        </div>
        <div class="pw-wizard__actions" style="justify-content:center;">
          <a href="<?php echo esc_url( add_query_arg( 'skip_wizard', '1', admin_url( 'admin.php?page=postwave' ) ) ); ?>" class="pw-wizard__btn pw-wizard__btn--primary"><?php esc_html_e( 'Go to Dashboard', 'tahhan-jmap-mailer' ); ?></a>
        </div>
      </div>
...
<div id="pw-toast" class="pw-toast" aria-live="polite" aria-atomic="true"></div>
  ...
  $tab_meta = array(
    'general'    => array(
      'label' => __( 'General', 'tahhan-jmap-mailer' ),
      'desc'  => __( 'Enable Tahhan JMAP Mailer and configure sender information.', 'tahhan-jmap-mailer' ),
      'icon'  => $icon_general,
    ),
    'accounts'   => array(
      'label' => __( 'Accounts', 'tahhan-jmap-mailer' ),
      'desc'  => __( 'Configure multiple JMAP accounts for routing.', 'tahhan-jmap-mailer' ),
      'icon'  => $icon_accounts,
    ),
    'routing'    => array(
      'label' => __( 'Routing', 'tahhan-jmap-mailer' ),
      'desc'  => __( 'Route emails to specific accounts based on conditions.', 'tahhan-jmap-mailer' ),
      'icon'  => $icon_routing,
    ),
    'connection' => array(
      'label' => __( 'Connection', 'tahhan-jmap-mailer' ),
      'desc'  => __( 'JMAP server credentials and connection testing.', 'tahhan-jmap-mailer' ),
      'icon'  => $icon_connection,
    ),
    'log'        => array(
      'label' => __( 'Mail Log', 'tahhan-jmap-mailer' ),
      'desc'  => __( 'Last 100 send attempts. Message bodies are never stored.', 'tahhan-jmap-mailer' ),
      'icon'  => $icon_log,
    ),
  );
  ...
  <header class="pw-app-header">
    <div class="pw-app-brand">
      ...
      <div class="pw-app-brand-text">
        <strong>Tahhan JMAP Mailer</strong>
    ...
    <div class="pw-app-header-right">
      ...
      if ( $enabled && $configured ) {
        echo '<span class="pw-status pw-status-active"><i></i>' . esc_html__( 'Active', 'tahhan-jmap-mailer' ) . '</span>';
      } elseif ( $configured ) {
        echo '<span class="pw-status pw-status-inactive"><i></i>' . esc_html__( 'Disabled', 'tahhan-jmap-mailer' ) . '</span>';
      } else {
        echo '<span class="pw-status pw-status-unconfigured"><i></i>' . esc_html__( 'Not configured', 'tahhan-jmap-mailer' ) . '</span>';
      }
      ?>
    </div>
  </header>
  ...
  <div class="pw-app-body">
    <main class="pw-main">
      ...
      <div class="pw-notice pw-notice-success">
        ...
        <?php esc_html_e( 'Settings saved successfully.', 'tahhan-jmap-mailer' ); ?>
      </div>
      <?php endif; ?>
      ...
      <div class="pw-notice pw-notice-success">
        <?php echo $icon_check; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
        <?php esc_html_e( 'Mail log cleared.', 'tahhan-jmap-mailer' ); ?>
      </div>
      <?php endif; ?>
      ...
      <div class="pw-stats-row">
        <?php
        $stats_cfg = [
          [ 'value' => $stats['sent_today'],   'label' => __( 'Sent today', 'tahhan-jmap-mailer' ),       'color' => 'blue' ],
          [ 'value' => $stats['failed_today'], 'label' => __( 'Failed today', 'tahhan-jmap-mailer' ),     'color' => 'red'  ],
          [ 'value' => $stats['sent_week'],    'label' => __( 'Sent this week', 'tahhan-jmap-mailer' ),   'color' => 'blue' ],
          [ 'value' => $stats['failed_week'],  'label' => __( 'Failed this week', 'tahhan-jmap-mailer' ), 'color' => 'red'  ],
          [ 'value' => $stats['total'],        'label' => __( 'Total logged', 'tahhan-jmap-mailer' ),     'color' => 'gray' ],
        ];
      ...
      <form method="post" action="<?php echo $act; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>">
          ...
          <div class="pw-panel-body">
            ...
            <div class="pw-toggle-row">
              <div class="pw-toggle-info">
                <strong><?php esc_html_e( 'Enable Tahhan JMAP Mailer', 'tahhan-jmap-mailer' ); ?></strong>
                <span><?php esc_html_e( 'Route all WordPress emails through your JMAP server', 'tahhan-jmap-mailer' ); ?></span>
              </div>
        ...
        <div class="pw-panel">
          <div class="pw-panel-header">
            <h3><?php esc_html_e( 'Sender Information', 'tahhan-jmap-mailer' ); ?></h3>
            <p><?php esc_html_e( 'The name and email address shown to recipients of outgoing mail.', 'tahhan-jmap-mailer' ); ?></p>
          </div>
          <div class="pw-panel-body">
            <div class="pw-row-2">
              <div class="pw-field">
                <label for="pw-from-name"><?php esc_html_e( 'From Name', 'tahhan-jmap-mailer' ); ?></label>
              ...
              <div class="pw-field">
                <label for="pw-from-email"><?php esc_html_e( 'From Email', 'tahhan-jmap-mailer' ); ?></label>
            ...
            <div class="pw-field pw-field-half">
              <label for="pw-test-recip">
                <?php esc_html_e( 'Test recipient', 'tahhan-jmap-mailer' ); ?>
                <em class="pw-label-opt"><?php esc_html_e( 'for Send Test Email button', 'tahhan-jmap-mailer' ); ?></em>
              </label>
              <input type="email" id="pw-test-recip" class="pw-input" name="postwave[test_recipient]"
                value="<?php echo esc_attr( $o( 'test_recipient' ) ); ?>"
                placeholder="<?php esc_attr_e( 'Falls back to From Email', 'tahhan-jmap-mailer' ); ?>">
            </div>
          </div>
          <div class="pw-panel-footer">
            <button type="submit" class="pw-btn pw-btn-primary"><?php esc_html_e( 'Save settings', 'tahhan-jmap-mailer' ); ?></button>
          </div>
        </div>
        ...
        <div class="pw-panel">
          <div class="pw-panel-header">
            <h3><?php esc_html_e( 'Automatic Retry', 'tahhan-jmap-mailer' ); ?></h3>
            <p><?php esc_html_e( 'Automatically re-send failed emails using WP-Cron with exponential backoff.', 'tahhan-jmap-mailer' ); ?></p>
          </div>
          <div class="pw-panel-body">
            <input type="hidden" name="postwave[retry_enabled]" value="0">
            <div class="pw-field-row pw-field-row--flex">
              <div class="pw-field-info">
                <label class="pw-label"><strong><?php esc_html_e( 'Enable retry queue', 'tahhan-jmap-mailer' ); ?></strong></label>
                <p class="pw-desc"><?php esc_html_e( 'Failed sends will be retried automatically in the background.', 'tahhan-jmap-mailer' ); ?></p>
              </div>
              <label class="pw-toggle">
            ...
            <div class="pw-field-row pw-retry-options <?php echo empty( $options['retry_enabled'] ) ? 'pw-hidden' : ''; ?>">
              <div class="pw-col-2">
                <label class="pw-label" for="pw-retry-max"><?php esc_html_e( 'Max retry attempts', 'tahhan-jmap-mailer' ); ?></label>
              ...
              <div class="pw-col-2">
                <label class="pw-label" for="pw-retry-delay"><?php esc_html_e( 'Initial retry delay', 'tahhan-jmap-mailer' ); ?></label>
                <select id="pw-retry-delay" name="postwave[retry_delay]" class="pw-select">
                  <option value="300"  <?php selected( (int) ( $options['retry_delay'] ?? 300 ), 300 );  ?>><?php esc_html_e( '5 minutes', 'tahhan-jmap-mailer' ); ?></option>
                  <option value="900"  <?php selected( (int) ( $options['retry_delay'] ?? 300 ), 900 );  ?>><?php esc_html_e( '15 minutes', 'tahhan-jmap-mailer' ); ?></option>
                  <option value="1800" <?php selected( (int) ( $options['retry_delay'] ?? 300 ), 1800 ); ?>><?php esc_html_e( '30 minutes', 'tahhan-jmap-mailer' ); ?></option>
                  <option value="3600" <?php selected( (int) ( $options['retry_delay'] ?? 300 ), 3600 ); ?>><?php esc_html_e( '1 hour', 'tahhan-jmap-mailer' ); ?></option>
                </select>
                <p class="pw-desc"><?php esc_html_e( 'Delay doubles on each retry attempt (exponential backoff).', 'tahhan-jmap-mailer' ); ?></p>
              </div>
            </div>
            ...
            <div class="pw-notice pw-notice--info" style="margin-top:16px;">
              <?php printf(
                ...
                esc_html( _n( '%d email is pending retry.', '%d emails are pending retry.', $retry_count, 'tahhan-jmap-mailer' ) ),
                (int) $retry_count
              ); ?>
            </div>
            <?php endif; ?>
        ...
        <div class="pw-panel">
          <div class="pw-panel-header">
            <h3><?php esc_html_e( 'Open Tracking', 'tahhan-jmap-mailer' ); ?></h3>
            <p><?php esc_html_e( 'Track when recipients open emails sent by your site. Opt-in only — read the privacy note below.', 'tahhan-jmap-mailer' ); ?></p>
          </div>
          <div class="pw-panel-body">
            <input type="hidden" name="postwave[tracking_enabled]" value="0">
            <div class="pw-field-row pw-field-row--flex">
              <div class="pw-field-info">
                <label class="pw-label"><strong><?php esc_html_e( 'Enable open tracking', 'tahhan-jmap-mailer' ); ?></strong></label>
                <p class="pw-desc"><?php esc_html_e( 'Embeds a 1×1 tracking pixel in outgoing HTML emails. Plain-text emails are never tracked.', 'tahhan-jmap-mailer' ); ?></p>
              </div>
              <label class="pw-toggle">
            ...
            <div class="pw-notice pw-notice--warning" style="margin-top:16px;">
              <strong><?php esc_html_e( 'Privacy:', 'tahhan-jmap-mailer' ); ?></strong>
              <?php esc_html_e( 'Open tracking records when an email is opened. You may need to disclose this in your privacy policy. No personal data is sent to external servers — tracking is handled entirely on your own WordPress installation.', 'tahhan-jmap-mailer' ); ?>
            </div>
          </div>
          <div class="pw-panel-footer">
            <button type="submit" class="pw-btn pw-btn-primary"><?php esc_html_e( 'Save settings', 'tahhan-jmap-mailer' ); ?></button>
      ...
      <div class="pw-notice pw-notice-success">
        <?php echo $icon_check; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
        <?php esc_html_e( 'Account deleted.', 'tahhan-jmap-mailer' ); ?>
      </div>
      <?php endif; ?>
      ...
      <div class="pw-account-grid">
        ...
        <div class="pw-account-card" data-account="<?php echo $acct_json; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>">
          <div class="pw-account-card-header">
            ...
            <span class="pw-badge--primary"><?php esc_html_e( 'Primary', 'tahhan-jmap-mailer' ); ?></span>
            <?php endif; ?>
          </div>
          <div class="pw-account-url"><?php echo esc_html( $acct['server_url'] ? $acct['server_url'] : __( '(no URL set)', 'tahhan-jmap-mailer' ) ); ?></div>
          <div class="pw-account-actions">
            <button type="button" class="pw-btn pw-btn-secondary pw-btn--sm pw-edit-account-btn">
              <?php esc_html_e( 'Edit', 'tahhan-jmap-mailer' ); ?>
            </button>
            <?php if ( empty( $acct['is_primary'] ) ) : ?>
            <form method="post" action="<?php echo $act; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>" style="display:inline;" onsubmit="return confirm('<?php echo esc_js( __( 'Delete this account?', 'tahhan-jmap-mailer' ) ); ?>')">
              ...
              <button type="submit" class="pw-btn pw-btn-danger pw-btn--sm"><?php esc_html_e( 'Delete', 'tahhan-jmap-mailer' ); ?></button>
            </form>
            <?php endif; ?>
          </div>
        </div>
      ...
      <div class="pw-empty-state">
        ...
        <p class="pw-empty-state__msg"><?php esc_html_e( 'Only the Primary account is configured. Add a second account to enable routing rules.', 'tahhan-jmap-mailer' ); ?></p>
      </div>
      <?php endif; ?>
      ...
      <div style="margin-bottom:20px;">
        <button type="button" class="pw-btn pw-btn-primary" id="pw-add-account-btn">
          + <?php esc_html_e( 'Add account', 'tahhan-jmap-mailer' ); ?>
        </button>
      </div>

      <!-- Add / Edit account inline form -->
      <div class="pw-inline-form pw-hidden" id="pw-account-form">
        <h3 id="pw-account-form-title"><?php esc_html_e( 'Add account', 'tahhan-jmap-mailer' ); ?></h3>
        <form method="post" action="<?php echo $act; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>">
          ...
          <div class="pw-form-grid-2">
            <div class="pw-field">
              <label for="pw-account-name"><?php esc_html_e( 'Account name', 'tahhan-jmap-mailer' ); ?></label>
              <input type="text" id="pw-account-name" class="pw-input" name="pw_account[name]" placeholder="<?php esc_attr_e( 'e.g. Primary', 'tahhan-jmap-mailer' ); ?>">
            </div>
            <div class="pw-field">
              <label for="pw-account-server-url"><?php esc_html_e( 'Server URL', 'tahhan-jmap-mailer' ); ?></label>
              <input type="url" id="pw-account-server-url" class="pw-input" name="pw_account[server_url]" placeholder="https://mail.example.com">
            </div>
            <div class="pw-field">
              <label for="pw-account-username"><?php esc_html_e( 'Username', 'tahhan-jmap-mailer' ); ?></label>
              <input type="text" id="pw-account-username" class="pw-input" name="pw_account[username]" autocomplete="off">
            </div>
            <div class="pw-field">
              <label for="pw-account-password"><?php esc_html_e( 'Password', 'tahhan-jmap-mailer' ); ?></label>
              <div class="pw-pass-wrap">
                <input type="password" id="pw-account-password" class="pw-input" name="pw_account[password]"
                  placeholder="<?php esc_attr_e( 'Leave blank to keep current', 'tahhan-jmap-mailer' ); ?>" autocomplete="new-password">
                <button type="button" class="pw-eye-btn" data-for="pw-account-password" tabindex="-1"
                  aria-label="<?php esc_attr_e( 'Toggle password visibility', 'tahhan-jmap-mailer' ); ?>">
          ...
          <details style="margin-top:12px;">
            <summary style="cursor:pointer;font-size:12px;color:var(--pw-muted,#787c82);margin-bottom:8px;"><?php esc_html_e( 'Identity override (advanced)', 'tahhan-jmap-mailer' ); ?></summary>
            <div class="pw-form-grid-2" style="margin-top:8px;">
              <div class="pw-field">
                <label for="pw-account-iid"><?php esc_html_e( 'Identity ID', 'tahhan-jmap-mailer' ); ?></label>
                <input type="text" id="pw-account-iid" class="pw-input" name="pw_account[identity_id]" placeholder="<?php esc_attr_e( 'Leave blank for auto-resolve', 'tahhan-jmap-mailer' ); ?>">
              </div>
              <div class="pw-field">
                <label for="pw-account-iname"><?php esc_html_e( 'Identity name', 'tahhan-jmap-mailer' ); ?></label>
                <input type="text" id="pw-account-iname" class="pw-input" name="pw_account[identity_name]">
              </div>
              <div class="pw-field">
                <label for="pw-account-iemail"><?php esc_html_e( 'Identity email', 'tahhan-jmap-mailer' ); ?></label>
          ...
          <div class="pw-form-actions">
            <button type="submit" class="pw-btn pw-btn-primary"><?php esc_html_e( 'Save account', 'tahhan-jmap-mailer' ); ?></button>
            <button type="button" class="pw-btn pw-btn-outline" id="pw-account-form-cancel"><?php esc_html_e( 'Cancel', 'tahhan-jmap-mailer' ); ?></button>
            <button type="button" class="pw-btn pw-btn-secondary" id="pw-test-account-btn"><?php esc_html_e( 'Test connection', 'tahhan-jmap-mailer' ); ?></button>
      ...
      <p style="font-size:13px;color:var(--pw-muted,#787c82);margin-bottom:20px;">
        <?php esc_html_e( 'Routing rules are evaluated in order (first match wins). Each rule sends matching emails via the specified account. Rules are skipped if disabled or if their conditions do not match.', 'tahhan-jmap-mailer' ); ?>
      </p>
      ...
      <div class="pw-empty-state">
        ...
        <p class="pw-empty-state__msg"><?php esc_html_e( 'No routing rules yet. Add a rule to route emails to different accounts based on recipient, subject, or plugin type.', 'tahhan-jmap-mailer' ); ?></p>
      </div>
      <?php endif; ?>
      <?php if ( ! empty( $rules ) ) : ?>
      <div class="pw-panel" style="margin-bottom:20px;">
        <div class="pw-panel-body pw-panel-body-flush">
          <table class="pw-rules-table">
            <thead>
              <tr>
                <th><?php esc_html_e( 'Priority', 'tahhan-jmap-mailer' ); ?></th>
                <th><?php esc_html_e( 'Rule name', 'tahhan-jmap-mailer' ); ?></th>
                <th><?php esc_html_e( 'Conditions', 'tahhan-jmap-mailer' ); ?></th>
                <th><?php esc_html_e( 'Account', 'tahhan-jmap-mailer' ); ?></th>
                <th><?php esc_html_e( 'Enabled', 'tahhan-jmap-mailer' ); ?></th>
                <th><?php esc_html_e( 'Actions', 'tahhan-jmap-mailer' ); ?></th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr>
                <td>
                  <div class="pw-priority-btns">
                    ...
                    <form method="post" action="<?php echo $act; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>" style="display:inline">
                      ...
                      <?php endforeach; ?>
                      <button type="submit" title="<?php esc_attr_e( 'Move up', 'tahhan-jmap-mailer' ); ?>">↑</button>
                    </form>
                    <?php else : ?>
                    ...
                    <form method="post" action="<?php echo $act; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>" style="display:inline">
                      ...
                      <input type="hidden" name="order[]" value="<?php echo esc_attr( $oid ); ?>">
                      <?php endforeach; ?>
                      <button type="submit" title="<?php esc_attr_e( 'Move down', 'tahhan-jmap-mailer' ); ?>">↓</button>
                    </form>
                    <?php else : ?>
                    <button type="button" disabled>↓</button>
                    <?php endif; ?>
                ...
                <td class="pw-rule-conditions">
                  ...
                  <?php echo implode( ' <em>' . esc_html( isset( $rule['condition_operator'] ) && 'all' === $rule['condition_operator'] ? __( 'AND', 'tahhan-jmap-mailer' ) : __( 'OR', 'tahhan-jmap-mailer' ) ) . '</em> ', $cond_summary ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- array items built with esc_html() ?>
                  <?php else : ?>
                  <em><?php esc_html_e( 'All emails', 'tahhan-jmap-mailer' ); ?></em>
                  <?php endif; ?>
                </td>
                <td><?php echo esc_html( $acct_name ); ?></td>
                <td>
                  <?php if ( ! empty( $rule['enabled'] ) ) : ?>
                  <span class="pw-badge--primary"><?php esc_html_e( 'Yes', 'tahhan-jmap-mailer' ); ?></span>
                  <?php else : ?>
                  <span style="color:var(--pw-muted,#787c82);font-size:12px;"><?php esc_html_e( 'No', 'tahhan-jmap-mailer' ); ?></span>
                  <?php endif; ?>
                </td>
                <td>
                  <div style="display:flex;gap:6px;">
                    ...
                    <form method="post" action="<?php echo $act; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>" style="display:inline;" onsubmit="return confirm('<?php echo esc_js( __( 'Delete this rule?', 'tahhan-jmap-mailer' ) ); ?>')">
      ...
      <div style="margin-bottom:20px;">
        <button type="button" class="pw-btn pw-btn-primary" id="pw-add-rule-btn">
          + <?php esc_html_e( 'Add rule', 'tahhan-jmap-mailer' ); ?>
        </button>
      </div>

      <!-- Add / Edit rule inline form -->
      <div class="pw-inline-form pw-hidden" id="pw-rule-form">
        <h3 id="pw-rule-form-title"><?php esc_html_e( 'Add rule', 'tahhan-jmap-mailer' ); ?></h3>
        <form method="post" action="<?php echo $act; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>">
          ...
          <div class="pw-form-grid-2">
            <div class="pw-field">
              <label for="pw-rule-name"><?php esc_html_e( 'Rule name', 'tahhan-jmap-mailer' ); ?></label>
              <input type="text" id="pw-rule-name" class="pw-input" name="pw_rule[name]" placeholder="<?php esc_attr_e( 'e.g. WooCommerce Orders', 'tahhan-jmap-mailer' ); ?>">
            </div>
            <div class="pw-field" style="display:flex;align-items:center;gap:10px;padding-top:22px;">
              ...
              <span style="font-size:13px;color:var(--pw-text,#2c3338);"><?php esc_html_e( 'Enabled', 'tahhan-jmap-mailer' ); ?></span>
            </div>
          </div>

          <!-- Condition operator -->
          <div class="pw-field" style="margin-top:16px;">
            <label><?php esc_html_e( 'Match operator', 'tahhan-jmap-mailer' ); ?></label>
            <div style="display:flex;gap:20px;margin-top:6px;">
              <label style="display:flex;align-items:center;gap:6px;font-size:13px;cursor:pointer;">
                <input type="radio" name="pw_rule[condition_operator]" value="any" checked>
                <?php esc_html_e( 'Match ANY condition', 'tahhan-jmap-mailer' ); ?>
              </label>
              <label style="display:flex;align-items:center;gap:6px;font-size:13px;cursor:pointer;">
                <input type="radio" name="pw_rule[condition_operator]" value="all">
                <?php esc_html_e( 'Match ALL conditions', 'tahhan-jmap-mailer' ); ?>
              </label>
            </div>
          </div>
          ...
          <!-- Conditions -->
          <div class="pw-field" style="margin-top:16px;">
            <label><?php esc_html_e( 'Conditions', 'tahhan-jmap-mailer' ); ?></label>
            <div class="pw-conditions-list" id="pw-conditions-list" style="margin-top:8px;"></div>
            <button type="button" class="pw-add-condition" id="pw-add-condition-btn">+ <?php esc_html_e( 'Add condition', 'tahhan-jmap-mailer' ); ?></button>
            <p class="pw-desc" style="margin-top:6px;">
              <?php esc_html_e( 'Plugin values: ', 'tahhan-jmap-mailer' ); ?>
          ...
          <div class="pw-form-grid-2" style="margin-top:16px;">
            <div class="pw-field">
              <label for="pw-rule-account"><?php esc_html_e( 'Target account', 'tahhan-jmap-mailer' ); ?></label>
            ...
            <div class="pw-field">
              <label for="pw-rule-identity"><?php esc_html_e( 'Override identity ID', 'tahhan-jmap-mailer' ); ?> <em class="pw-label-opt"><?php esc_html_e( 'optional', 'tahhan-jmap-mailer' ); ?></em></label>
              <input type="text" id="pw-rule-identity" class="pw-input" name="pw_rule[identity_id]" placeholder="<?php esc_attr_e( 'Leave blank to use account default', 'tahhan-jmap-mailer' ); ?>">
            </div>
          </div>

          <div class="pw-form-actions">
            <button type="submit" class="pw-btn pw-btn-primary"><?php esc_html_e( 'Save rule', 'tahhan-jmap-mailer' ); ?></button>
            <button type="button" class="pw-btn pw-btn-outline" id="pw-rule-form-cancel"><?php esc_html_e( 'Cancel', 'tahhan-jmap-mailer' ); ?></button>
          </div>
        </form>
      </div>
      ...
      <form method="post" action="<?php echo $act; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>">
        ...
        <div class="pw-panel">
          <div class="pw-panel-header">
            <h3><?php esc_html_e( 'Server Configuration', 'tahhan-jmap-mailer' ); ?></h3>
            <p><?php esc_html_e( 'Your JMAP server URL, username, and password.', 'tahhan-jmap-mailer' ); ?></p>
          </div>
          <div class="pw-panel-body">
            <div class="pw-field">
              <label for="pw-server-url"><?php esc_html_e( 'JMAP Server URL', 'tahhan-jmap-mailer' ); ?></label>
              <input type="url" id="pw-server-url" class="pw-input" name="postwave[server_url]"
                value="<?php echo esc_attr( $o( 'server_url' ) ); ?>"
                placeholder="https://mail.example.com">
              <span class="pw-field-hint"><?php esc_html_e( 'Session is auto-discovered at /.well-known/jmap', 'tahhan-jmap-mailer' ); ?></span>
            </div>
            <div class="pw-row-2">
              <div class="pw-field">
                <label for="pw-username"><?php esc_html_e( 'Username', 'tahhan-jmap-mailer' ); ?></label>
                <input type="text" id="pw-username" class="pw-input" name="postwave[username]"
                  value="<?php echo esc_attr( $o( 'username' ) ); ?>" autocomplete="off">
              </div>
              <div class="pw-field">
                <label for="pw-password"><?php esc_html_e( 'Password', 'tahhan-jmap-mailer' ); ?></label>
                <div class="pw-pass-wrap">
                  <input type="password" id="pw-password" class="pw-input" name="postwave[password]"
                    placeholder="<?php esc_attr_e( 'Leave blank to keep current', 'tahhan-jmap-mailer' ); ?>"
                ...
                <span class="pw-field-hint pw-field-hint-ok">
                  ...
                  <?php esc_html_e( 'Password saved — leave blank to keep current', 'tahhan-jmap-mailer' ); ?>
                </span>
                <?php endif; ?>
              </div>
            </div>
          ...
          <div class="pw-panel-footer">
            <button type="submit" class="pw-btn pw-btn-primary"><?php esc_html_e( 'Save credentials', 'tahhan-jmap-mailer' ); ?></button>
          </div>
        </div>
        ...
        <div class="pw-panel">
          <div class="pw-panel-header">
            <h3><?php esc_html_e( 'Sender Identity', 'tahhan-jmap-mailer' ); ?></h3>
            <p><?php esc_html_e( 'Choose which JMAP sending identity to use. Auto-resolve matches the From email to an identity on your server.', 'tahhan-jmap-mailer' ); ?></p>
          </div>
          <div class="pw-panel-body">
            <div class="pw-field">
              <label class="pw-label" for="pw-identity-select"><?php esc_html_e( 'Identity', 'tahhan-jmap-mailer' ); ?></label>
              <div class="pw-identity-wrap">
                <div class="pw-identity-controls">
                  <select id="pw-identity-select" name="postwave[identity_id]" class="pw-select pw-identity-dropdown">
                    <option value=""><?php esc_html_e( '— Auto-resolve (recommended) —', 'tahhan-jmap-mailer' ); ?></option>
                    <?php
                  ...
                  <button type="button" id="pw-load-identities" class="pw-btn pw-btn--secondary pw-btn-secondary">
                    <?php esc_html_e( 'Load identities', 'tahhan-jmap-mailer' ); ?>
                  </button>
                </div>
                <p class="pw-desc" style="margin-top:6px;"><?php esc_html_e( 'Click "Load identities" to fetch the list from your JMAP server. Save credentials on the Connection tab first.', 'tahhan-jmap-mailer' ); ?></p>
                <p id="pw-identity-status" class="pw-desc pw-hidden" style="margin-top:4px;"></p>
              </div>
            </div>
          </div>
          <div class="pw-panel-footer">
            <button type="submit" class="pw-btn pw-btn-primary"><?php esc_html_e( 'Save identity', 'tahhan-jmap-mailer' ); ?></button>
          </div>
        </div>
      </form>
      ...
      <div class="pw-panel pw-panel-test">
        <div class="pw-panel-header">
          <h3><?php esc_html_e( 'Test Connection', 'tahhan-jmap-mailer' ); ?></h3>
          <p><?php esc_html_e( 'Save your credentials first, then verify the server responds correctly.', 'tahhan-jmap-mailer' ); ?></p>
        </div>
        <div class="pw-panel-body">
          <div class="pw-test-actions">
            <button type="button" class="pw-btn pw-btn-secondary" id="pw-test-conn">
              ...
              <?php esc_html_e( 'Test connection', 'tahhan-jmap-mailer' ); ?>
            </button>
            <button type="button" class="pw-btn pw-btn-secondary" id="pw-test-email">
              ...
              <?php esc_html_e( 'Send test email', 'tahhan-jmap-mailer' ); ?>
            </button>
          </div>
          ...
          <div id="pw-steps" style="display:none">
            <div class="pw-step-row" id="pw-step-discover">
              ...
              <span><?php esc_html_e( 'Discovering JMAP session…', 'tahhan-jmap-mailer' ); ?></span>
            </div>
            <div class="pw-step-row pw-step-row--pending" id="pw-step-identity">
              <span class="pw-step-dot">○</span>
              <span><?php esc_html_e( 'Resolving sender identity…', 'tahhan-jmap-mailer' ); ?></span>
            </div>
            <div class="pw-step-row pw-step-row--pending" id="pw-step-done">
              <span class="pw-step-dot">○</span>
              <span><?php esc_html_e( 'Verifying capabilities…', 'tahhan-jmap-mailer' ); ?></span>
            </div>
          </div>
      ...
      <div class="pw-panel">
        <div class="pw-panel-header pw-panel-header-row">
          <div>
            <h3><?php esc_html_e( 'Mail Log', 'tahhan-jmap-mailer' ); ?></h3>
            <p><?php esc_html_e( 'Last 100 send attempts. Bodies are never stored.', 'tahhan-jmap-mailer' ); ?></p>
          </div>
          ...
          <div style="display:flex;gap:8px;align-items:center;flex-shrink:0;">
            <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" style="display:inline;">
              ...
              <button type="submit" class="pw-btn pw-btn-secondary pw-btn--sm">
                &#8595; <?php esc_html_e( 'Export CSV', 'tahhan-jmap-mailer' ); ?>
              </button>
            </form>
            <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" style="display:inline;">
              ...
              <button type="submit" class="pw-btn pw-btn-danger pw-btn--sm"
                onclick="return confirm('<?php echo esc_js( __( 'Clear all log entries? This cannot be undone.', 'tahhan-jmap-mailer' ) ); ?>')">
                ...
                <?php esc_html_e( 'Clear log', 'tahhan-jmap-mailer' ); ?>
              </button>
            </form>
          </div>
          <?php endif; ?>
        ...
        <div class="pw-panel-body pw-panel-body-flush">
          ...
          <div class="pw-empty-state">
            ...
            <h4><?php esc_html_e( 'No emails logged yet', 'tahhan-jmap-mailer' ); ?></h4>
            <p><?php esc_html_e( 'Sent and failed emails will appear here once Tahhan JMAP Mailer is active.', 'tahhan-jmap-mailer' ); ?></p>
          </div>
          <?php else : ?>
          <div class="pw-table-scroll">
            <table class="pw-table">
              <thead>
                <tr>
                  <th><?php esc_html_e( 'Status', 'tahhan-jmap-mailer' ); ?></th>
                  <th><?php esc_html_e( 'Date / Time', 'tahhan-jmap-mailer' ); ?></th>
                  <th><?php esc_html_e( 'To', 'tahhan-jmap-mailer' ); ?></th>
                  <th><?php esc_html_e( 'Subject', 'tahhan-jmap-mailer' ); ?></th>
                  <th title="<?php esc_attr_e( 'When the recipient opened this email (requires open tracking to be enabled)', 'tahhan-jmap-mailer' ); ?>"><?php esc_html_e( 'Opened', 'tahhan-jmap-mailer' ); ?></th>
                  <th><?php esc_html_e( 'Details', 'tahhan-jmap-mailer' ); ?></th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr>
                  <td>
                    <span class="pw-badge-pill pw-badge-pill-<?php echo $sent ? 'success' : 'danger'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>">
                      <?php echo $sent ? esc_html__( 'Sent', 'tahhan-jmap-mailer' ) : esc_html__( 'Failed', 'tahhan-jmap-mailer' ); ?>
                    </span>
                    <?php if ( 'retried' === $retry_status ) : ?>
                    <span class="pw-badge pw-badge--retried" title="<?php esc_attr_e( 'Sent via retry queue', 'tahhan-jmap-mailer' ); ?>">
                      <?php echo esc_html( sprintf(
                        /* translators: %d: number of retries */
                        _n( 'retry %d', 'retry %d', (int) ( $e['retry_count'] ?? 1 ), 'tahhan-jmap-mailer' ),
                        (int) ( $e['retry_count'] ?? 1 )
                      ) ); ?>
                    </span>
                    <?php elseif ( 'exhausted' === $retry_status ) : ?>
                    <span class="pw-badge pw-badge--exhausted" title="<?php esc_attr_e( 'All retry attempts exhausted', 'tahhan-jmap-mailer' ); ?>">
                      <?php esc_html_e( 'exhausted', 'tahhan-jmap-mailer' ); ?>
                    </span>
                    <?php endif; ?>
                  </td>
                  ...
                  <td class="pw-td-opened">
                    ...
                    <?php else : ?>
                    <span class="pw-opened-no" title="<?php esc_attr_e( 'Not yet opened, or open tracking is disabled', 'tahhan-jmap-mailer' ); ?>">—</span>
                    <?php endif; ?>
                  </td>
                  <td class="pw-td-detail">
                    <button type="button" class="pw-detail-btn"><?php esc_html_e( 'Details', 'tahhan-jmap-mailer' ); ?> ▾</button>
                    <dl class="pw-detail-panel" style="display:none">
                      <?php if ( ! empty( $e['from'] ) ) : ?>
                      <div><dt><?php esc_html_e( 'From', 'tahhan-jmap-mailer' ); ?></dt><dd><code><?php echo esc_html( $e['from'] ); ?></code></dd></div>
                      <?php endif; ?>
                      <?php if ( ! empty( $e['account_id'] ) ) : ?>
                      <div><dt><?php esc_html_e( 'Account', 'tahhan-jmap-mailer' ); ?></dt><dd><code><?php echo esc_html( $e['account_id'] ); ?></code></dd></div>
                      <?php endif; ?>
                      <?php if ( ! empty( $e['identity_id'] ) ) : ?>
                      <div><dt><?php esc_html_e( 'Identity', 'tahhan-jmap-mailer' ); ?></dt><dd><code><?php echo esc_html( $e['identity_id'] ); ?></code></dd></div>
                      <?php endif; ?>
                      <?php if ( ! empty( $e['email_id'] ) ) : ?>
                      <div><dt><?php esc_html_e( 'Email ID', 'tahhan-jmap-mailer' ); ?></dt><dd><code><?php echo esc_html( $e['email_id'] ); ?></code></dd></div>
                      <?php endif; ?>
                      <?php if ( ! empty( $opened_at ) ) : ?>
                      <div><dt><?php esc_html_e( 'Opened', 'tahhan-jmap-mailer' ); ?></dt><dd><?php echo esc_html( wp_date( 'Y-m-d H:i:s', (int) $opened_at ) ); ?></dd></div>
                      <?php endif; ?>
                      <?php if ( ! empty( $e['error'] ) ) : ?>
                      <div class="pw-detail-error"><dt><?php esc_html_e( 'Error', 'tahhan-jmap-mailer' ); ?></dt><dd><?php echo esc_html( $e['error'] ); ?></dd></div>
                      <?php endif; ?>
                    </dl>
                  </td>
                </tr>
