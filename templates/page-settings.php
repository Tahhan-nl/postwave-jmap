...
<div id="pw-wizard" class="pw-wizard-overlay">
  <div class="pw-wizard__card">
    <div class="pw-wizard__header">
      ...
      <h1 class="pw-wizard__title"><?php esc_html_e( 'Welcome to Postwave', 'postwave-jmap' ); ?></h1>
      <p class="pw-wizard__sub"><?php esc_html_e( 'Modern email for WordPress', 'postwave-jmap' ); ?></p>
    ...
    <div class="pw-wizard__body">
      ...
      <div class="pw-wizard__step pw-wizard__step--active">
        <p style="font-size:15px;color:#374151;margin:0 0 20px;"><?php esc_html_e( 'Send every WordPress email through your own JMAP mail server — no SMTP ports, no relay limits.', 'postwave-jmap' ); ?></p>
        <ul style="list-style:none;padding:0;margin:0 0 24px;display:flex;flex-direction:column;gap:12px;">
          <li style="display:flex;align-items:flex-start;gap:10px;">
            ...
            <span style="font-size:13px;color:#374151;"><?php esc_html_e( 'RFC 8620/8621 — works with Stalwart, Fastmail &amp; more', 'postwave-jmap' ); ?></span>
          </li>
          <li style="display:flex;align-items:flex-start;gap:10px;">
            <svg viewBox="0 0 20 20" fill="#6366f1" width="18" height="18" style="flex-shrink:0;margin-top:2px;"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/></svg>
            <span style="font-size:13px;color:#374151;"><?php esc_html_e( 'Multi-account routing — send order emails from a dedicated address', 'postwave-jmap' ); ?></span>
          </li>
          <li style="display:flex;align-items:flex-start;gap:10px;">
            <svg viewBox="0 0 20 20" fill="#6366f1" width="18" height="18" style="flex-shrink:0;margin-top:2px;"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/></svg>
            <span style="font-size:13px;color:#374151;"><?php esc_html_e( 'Retry queue, open tracking, and full mail log included', 'postwave-jmap' ); ?></span>
          </li>
        </ul>
        <div class="pw-wizard__actions">
          <a href="<?php echo esc_url( add_query_arg( 'skip_wizard', '1', admin_url( 'admin.php?page=postwave' ) ) ); ?>" class="pw-wizard__btn pw-wizard__btn--ghost"><?php esc_html_e( 'Skip for now', 'postwave-jmap' ); ?></a>
          <button type="button" class="pw-wizard__btn pw-wizard__btn--primary" data-wizard-next="1"><?php esc_html_e( 'Get Started', 'postwave-jmap' ); ?> &rarr;</button>
        </div>
      </div>
      ...
      <div class="pw-wizard__step">
        <form method="post" action="<?php echo $act; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>" id="pw-wz-form">
          ...
          <div class="pw-wizard__field">
            <label for="pw-wz-url"><?php esc_html_e( 'Server URL', 'postwave-jmap' ); ?></label>
            ...
            <span style="font-size:12px;color:#6b7280;margin-top:4px;display:block;"><?php esc_html_e( 'JMAP session is auto-discovered at /.well-known/jmap', 'postwave-jmap' ); ?></span>
          </div>
          <div class="pw-wizard__field">
            <label for="pw-wz-user"><?php esc_html_e( 'Username', 'postwave-jmap' ); ?></label>
            <input type="text" id="pw-wz-user" name="postwave[username]"
              value="<?php echo esc_attr( $o( 'username' ) ); ?>" autocomplete="username" required>
          </div>
          <div class="pw-wizard__field">
            <label for="pw-wz-pass"><?php esc_html_e( 'Password', 'postwave-jmap' ); ?></label>
            <input type="password" id="pw-wz-pass" name="postwave[password]" autocomplete="new-password">
          </div>
          <div class="pw-wizard__actions">
            <button type="button" class="pw-wizard__btn pw-wizard__btn--ghost" data-wizard-next="0">&larr; <?php esc_html_e( 'Back', 'postwave-jmap' ); ?></button>
            <button type="button" class="pw-wizard__btn pw-wizard__btn--primary" data-wizard-next="2"><?php esc_html_e( 'Test &amp; Continue', 'postwave-jmap' ); ?> &rarr;</button>
          </div>
        </form>
      </div>
      ...
      <div class="pw-wizard__step">
        <div class="pw-wizard__field">
          <label for="pw-wz-iname"><?php esc_html_e( 'Identity Name', 'postwave-jmap' ); ?></label>
          <input type="text" id="pw-wz-iname" name="postwave[identity_name]"
            value="<?php echo esc_attr( $o( 'identity_name', get_bloginfo( 'name' ) ) ); ?>">
        </div>
        <div class="pw-wizard__field">
          <label for="pw-wz-iemail"><?php esc_html_e( 'Identity Email', 'postwave-jmap' ); ?></label>
        ...
        <div class="pw-wizard__field">
          <label for="pw-wz-iid"><?php esc_html_e( 'Identity ID', 'postwave-jmap' ); ?> <span style="font-size:11px;color:#9ca3af;"><?php esc_html_e( 'optional — leave blank to auto-resolve', 'postwave-jmap' ); ?></span></label>
          <input type="text" id="pw-wz-iid" name="postwave[identity_id]"
            value="<?php echo esc_attr( $o( 'identity_id' ) ); ?>"
            placeholder="<?php esc_attr_e( 'Auto-resolve from server', 'postwave-jmap' ); ?>">
        </div>
        <div class="pw-wizard__actions">
          <button type="button" class="pw-wizard__btn pw-wizard__btn--ghost" data-wizard-next="1">&larr; <?php esc_html_e( 'Back', 'postwave-jmap' ); ?></button>
          <button type="button" class="pw-wizard__btn pw-wizard__btn--primary" data-wizard-next="3"><?php esc_html_e( 'Save &amp; Continue', 'postwave-jmap' ); ?> &rarr;</button>
        </div>
      </div>
      ...
      <div class="pw-wizard__step">
        <div class="pw-wizard__success">
          ...
          <h2 style="font-size:20px;font-weight:700;color:#1d2327;margin:0 0 8px;"><?php esc_html_e( 'Postwave is ready!', 'postwave-jmap' ); ?></h2>
          <p style="font-size:14px;color:#6b7280;margin:0 0 20px;"><?php esc_html_e( 'Your JMAP server is configured. Enable Postwave on the General tab to start routing emails.', 'postwave-jmap' ); ?></p>
          <ul style="list-style:none;padding:0;margin:0 0 24px;text-align:left;display:inline-block;">
            <li style="font-size:13px;color:#374151;margin-bottom:8px;">&#10003; <?php esc_html_e( 'Server connected', 'postwave-jmap' ); ?></li>
            <li style="font-size:13px;color:#374151;margin-bottom:8px;">&#10003; <?php esc_html_e( 'Identity configured', 'postwave-jmap' ); ?></li>
            <li style="font-size:13px;color:#374151;">&#10003; <?php esc_html_e( 'Ready to send', 'postwave-jmap' ); ?></li>
          </ul>
        </div>
        <div class="pw-wizard__actions" style="justify-content:center;">
          <a href="<?php echo esc_url( add_query_arg( 'skip_wizard', '1', admin_url( 'admin.php?page=postwave' ) ) ); ?>" class="pw-wizard__btn pw-wizard__btn--primary"><?php esc_html_e( 'Go to Dashboard', 'postwave-jmap' ); ?></a>
        </div>
      </div>
...
<div id="pw-toast" class="pw-toast" aria-live="polite" aria-atomic="true"></div>
  ...
  $tab_meta = array(
    'general'    => array(
      'label' => __( 'General', 'postwave-jmap' ),
      'desc'  => __( 'Enable Postwave JMAP and configure sender information.', 'postwave-jmap' ),
      'icon'  => $icon_general,
    ),
    'accounts'   => array(
      'label' => __( 'Accounts', 'postwave-jmap' ),
      'desc'  => __( 'Configure multiple JMAP accounts for routing.', 'postwave-jmap' ),
      'icon'  => $icon_accounts,
    ),
    'routing'    => array(
      'label' => __( 'Routing', 'postwave-jmap' ),
      'desc'  => __( 'Route emails to specific accounts based on conditions.', 'postwave-jmap' ),
      'icon'  => $icon_routing,
    ),
    'connection' => array(
      'label' => __( 'Connection', 'postwave-jmap' ),
      'desc'  => __( 'JMAP server credentials and connection testing.', 'postwave-jmap' ),
      'icon'  => $icon_connection,
    ),
    'log'        => array(
      'label' => __( 'Mail Log', 'postwave-jmap' ),
      'desc'  => __( 'Last 100 send attempts. Message bodies are never stored.', 'postwave-jmap' ),
      'icon'  => $icon_log,
    ),
  );
  ...
  <header class="pw-app-header">
    ...
    <div class="pw-app-header-right">
      ...
      if ( $enabled && $configured ) {
        echo '<span class="pw-status pw-status-active"><i></i>' . esc_html__( 'Active', 'postwave-jmap' ) . '</span>';
      } elseif ( $configured ) {
        echo '<span class="pw-status pw-status-inactive"><i></i>' . esc_html__( 'Disabled', 'postwave-jmap' ) . '</span>';
      } else {
        echo '<span class="pw-status pw-status-unconfigured"><i></i>' . esc_html__( 'Not configured', 'postwave-jmap' ) . '</span>';
      }
      ?>
    </div>
  </header>
  ...
  <div class="pw-app-body">
    <main class="pw-main">
      ...
      <div class="pw-notice pw-notice-success">
        ...
        <?php esc_html_e( 'Settings saved successfully.', 'postwave-jmap' ); ?>
      </div>
      <?php endif; ?>
      ...
      <div class="pw-notice pw-notice-success">
        <?php echo $icon_check; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
        <?php esc_html_e( 'Mail log cleared.', 'postwave-jmap' ); ?>
      </div>
      <?php endif; ?>
      ...
      <div class="pw-stats-row">
        <?php
        $stats_cfg = [
          [ 'value' => $stats['sent_today'],   'label' => __( 'Sent today', 'postwave-jmap' ),       'color' => 'blue' ],
          [ 'value' => $stats['failed_today'], 'label' => __( 'Failed today', 'postwave-jmap' ),     'color' => 'red'  ],
          [ 'value' => $stats['sent_week'],    'label' => __( 'Sent this week', 'postwave-jmap' ),   'color' => 'blue' ],
          [ 'value' => $stats['failed_week'],  'label' => __( 'Failed this week', 'postwave-jmap' ), 'color' => 'red'  ],
          [ 'value' => $stats['total'],        'label' => __( 'Total logged', 'postwave-jmap' ),     'color' => 'gray' ],
        ];
      ...
      <form method="post" action="<?php echo $act; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>">
          ...
          <div class="pw-panel-body">
            ...
            <div class="pw-toggle-row">
              <div class="pw-toggle-info">
                <strong><?php esc_html_e( 'Enable Postwave JMAP', 'postwave-jmap' ); ?></strong>
                <span><?php esc_html_e( 'Route all WordPress emails through your JMAP server', 'postwave-jmap' ); ?></span>
              </div>
        ...
        <div class="pw-panel">
          <div class="pw-panel-header">
            <h3><?php esc_html_e( 'Sender Information', 'postwave-jmap' ); ?></h3>
            <p><?php esc_html_e( 'The name and email address shown to recipients of outgoing mail.', 'postwave-jmap' ); ?></p>
          </div>
          <div class="pw-panel-body">
            <div class="pw-row-2">
              <div class="pw-field">
                <label for="pw-from-name"><?php esc_html_e( 'From Name', 'postwave-jmap' ); ?></label>
              ...
              <div class="pw-field">
                <label for="pw-from-email"><?php esc_html_e( 'From Email', 'postwave-jmap' ); ?></label>
            ...
            <div class="pw-field pw-field-half">
              <label for="pw-test-recip">
                <?php esc_html_e( 'Test recipient', 'postwave-jmap' ); ?>
                <em class="pw-label-opt"><?php esc_html_e( 'for Send Test Email button', 'postwave-jmap' ); ?></em>
              </label>
              <input type="email" id="pw-test-recip" class="pw-input" name="postwave[test_recipient]"
                value="<?php echo esc_attr( $o( 'test_recipient' ) ); ?>"
                placeholder="<?php esc_attr_e( 'Falls back to From Email', 'postwave-jmap' ); ?>">
            </div>
          </div>
          <div class="pw-panel-footer">
            <button type="submit" class="pw-btn pw-btn-primary"><?php esc_html_e( 'Save settings', 'postwave-jmap' ); ?></button>
          </div>
        </div>
        ...
        <div class="pw-panel">
          <div class="pw-panel-header">
            <h3><?php esc_html_e( 'Automatic Retry', 'postwave-jmap' ); ?></h3>
            <p><?php esc_html_e( 'Automatically re-send failed emails using WP-Cron with exponential backoff.', 'postwave-jmap' ); ?></p>
          </div>
          <div class="pw-panel-body">
            <input type="hidden" name="postwave[retry_enabled]" value="0">
            <div class="pw-field-row pw-field-row--flex">
              <div class="pw-field-info">
                <label class="pw-label"><strong><?php esc_html_e( 'Enable retry queue', 'postwave-jmap' ); ?></strong></label>
                <p class="pw-desc"><?php esc_html_e( 'Failed sends will be retried automatically in the background.', 'postwave-jmap' ); ?></p>
              </div>
              <label class="pw-toggle">
            ...
            <div class="pw-field-row pw-retry-options <?php echo empty( $options['retry_enabled'] ) ? 'pw-hidden' : ''; ?>">
              <div class="pw-col-2">
                <label class="pw-label" for="pw-retry-max"><?php esc_html_e( 'Max retry attempts', 'postwave-jmap' ); ?></label>
              ...
              <div class="pw-col-2">
                <label class="pw-label" for="pw-retry-delay"><?php esc_html_e( 'Initial retry delay', 'postwave-jmap' ); ?></label>
                <select id="pw-retry-delay" name="postwave[retry_delay]" class="pw-select">
                  <option value="300"  <?php selected( (int) ( $options['retry_delay'] ?? 300 ), 300 );  ?>><?php esc_html_e( '5 minutes', 'postwave-jmap' ); ?></option>
                  <option value="900"  <?php selected( (int) ( $options['retry_delay'] ?? 300 ), 900 );  ?>><?php esc_html_e( '15 minutes', 'postwave-jmap' ); ?></option>
                  <option value="1800" <?php selected( (int) ( $options['retry_delay'] ?? 300 ), 1800 ); ?>><?php esc_html_e( '30 minutes', 'postwave-jmap' ); ?></option>
                  <option value="3600" <?php selected( (int) ( $options['retry_delay'] ?? 300 ), 3600 ); ?>><?php esc_html_e( '1 hour', 'postwave-jmap' ); ?></option>
                </select>
                <p class="pw-desc"><?php esc_html_e( 'Delay doubles on each retry attempt (exponential backoff).', 'postwave-jmap' ); ?></p>
              </div>
            </div>
            ...
            <div class="pw-notice pw-notice--info" style="margin-top:16px;">
              <?php printf(
                ...
                esc_html( _n( '%d email is pending retry.', '%d emails are pending retry.', $retry_count, 'postwave-jmap' ) ),
                (int) $retry_count
              ); ?>
            </div>
            <?php endif; ?>
        ...
        <div class="pw-panel">
          <div class="pw-panel-header">
            <h3><?php esc_html_e( 'Open Tracking', 'postwave-jmap' ); ?></h3>
            <p><?php esc_html_e( 'Track when recipients open emails sent by your site. Opt-in only — read the privacy note below.', 'postwave-jmap' ); ?></p>
          </div>
          <div class="pw-panel-body">
            <input type="hidden" name="postwave[tracking_enabled]" value="0">
            <div class="pw-field-row pw-field-row--flex">
              <div class="pw-field-info">
                <label class="pw-label"><strong><?php esc_html_e( 'Enable open tracking', 'postwave-jmap' ); ?></strong></label>
                <p class="pw-desc"><?php esc_html_e( 'Embeds a 1×1 tracking pixel in outgoing HTML emails. Plain-text emails are never tracked.', 'postwave-jmap' ); ?></p>
              </div>
              <label class="pw-toggle">
            ...
            <div class="pw-notice pw-notice--warning" style="margin-top:16px;">
              <strong><?php esc_html_e( 'Privacy:', 'postwave-jmap' ); ?></strong>
              <?php esc_html_e( 'Open tracking records when an email is opened. You may need to disclose this in your privacy policy. No personal data is sent to external servers — tracking is handled entirely on your own WordPress installation.', 'postwave-jmap' ); ?>
            </div>
          </div>
          <div class="pw-panel-footer">
            <button type="submit" class="pw-btn pw-btn-primary"><?php esc_html_e( 'Save settings', 'postwave-jmap' ); ?></button>
      ...
      <div class="pw-notice pw-notice-success">
        <?php echo $icon_check; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
        <?php esc_html_e( 'Account deleted.', 'postwave-jmap' ); ?>
      </div>
      <?php endif; ?>
      ...
      <div class="pw-account-grid">
        ...
        <div class="pw-account-card" data-account="<?php echo $acct_json; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>">
          <div class="pw-account-card-header">
            ...
            <span class="pw-badge--primary"><?php esc_html_e( 'Primary', 'postwave-jmap' ); ?></span>
            <?php endif; ?>
          </div>
          <div class="pw-account-url"><?php echo esc_html( $acct['server_url'] ? $acct['server_url'] : __( '(no URL set)', 'postwave-jmap' ) ); ?></div>
          <div class="pw-account-actions">
            <button type="button" class="pw-btn pw-btn-secondary pw-btn--sm pw-edit-account-btn">
              <?php esc_html_e( 'Edit', 'postwave-jmap' ); ?>
            </button>
            <?php if ( empty( $acct['is_primary'] ) ) : ?>
            <form method="post" action="<?php echo $act; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>" style="display:inline;" onsubmit="return confirm('<?php echo esc_js( __( 'Delete this account?', 'postwave-jmap' ) ); ?>')">
              ...
              <button type="submit" class="pw-btn pw-btn-danger pw-btn--sm"><?php esc_html_e( 'Delete', 'postwave-jmap' ); ?></button>
            </form>
            <?php endif; ?>
          </div>
        </div>
      ...
      <div class="pw-empty-state">
        ...
        <p class="pw-empty-state__msg"><?php esc_html_e( 'Only the Primary account is configured. Add a second account to enable routing rules.', 'postwave-jmap' ); ?></p>
      </div>
      <?php endif; ?>
      ...
      <div style="margin-bottom:20px;">
        <button type="button" class="pw-btn pw-btn-primary" id="pw-add-account-btn">
          + <?php esc_html_e( 'Add account', 'postwave-jmap' ); ?>
        </button>
      </div>

      <!-- Add / Edit account inline form -->
      <div class="pw-inline-form pw-hidden" id="pw-account-form">
        <h3 id="pw-account-form-title"><?php esc_html_e( 'Add account', 'postwave-jmap' ); ?></h3>
        <form method="post" action="<?php echo $act; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>">
          ...
          <div class="pw-form-grid-2">
            <div class="pw-field">
              <label for="pw-account-name"><?php esc_html_e( 'Account name', 'postwave-jmap' ); ?></label>
              <input type="text" id="pw-account-name" class="pw-input" name="pw_account[name]" placeholder="<?php esc_attr_e( 'e.g. Primary', 'postwave-jmap' ); ?>">
            </div>
            <div class="pw-field">
              <label for="pw-account-server-url"><?php esc_html_e( 'Server URL', 'postwave-jmap' ); ?></label>
              <input type="url" id="pw-account-server-url" class="pw-input" name="pw_account[server_url]" placeholder="https://mail.example.com">
            </div>
            <div class="pw-field">
              <label for="pw-account-username"><?php esc_html_e( 'Username', 'postwave-jmap' ); ?></label>
              <input type="text" id="pw-account-username" class="pw-input" name="pw_account[username]" autocomplete="off">
            </div>
            <div class="pw-field">
              <label for="pw-account-password"><?php esc_html_e( 'Password', 'postwave-jmap' ); ?></label>
              <div class="pw-pass-wrap">
                <input type="password" id="pw-account-password" class="pw-input" name="pw_account[password]"
                  placeholder="<?php esc_attr_e( 'Leave blank to keep current', 'postwave-jmap' ); ?>" autocomplete="new-password">
                <button type="button" class="pw-eye-btn" data-for="pw-account-password" tabindex="-1"
                  aria-label="<?php esc_attr_e( 'Toggle password visibility', 'postwave-jmap' ); ?>">
          ...
          <details style="margin-top:12px;">
            <summary style="cursor:pointer;font-size:12px;color:var(--pw-muted,#787c82);margin-bottom:8px;"><?php esc_html_e( 'Identity override (advanced)', 'postwave-jmap' ); ?></summary>
            <div class="pw-form-grid-2" style="margin-top:8px;">
              <div class="pw-field">
                <label for="pw-account-iid"><?php esc_html_e( 'Identity ID', 'postwave-jmap' ); ?></label>
                <input type="text" id="pw-account-iid" class="pw-input" name="pw_account[identity_id]" placeholder="<?php esc_attr_e( 'Leave blank for auto-resolve', 'postwave-jmap' ); ?>">
              </div>
              <div class="pw-field">
                <label for="pw-account-iname"><?php esc_html_e( 'Identity name', 'postwave-jmap' ); ?></label>
                <input type="text" id="pw-account-iname" class="pw-input" name="pw_account[identity_name]">
              </div>
              <div class="pw-field">
                <label for="pw-account-iemail"><?php esc_html_e( 'Identity email', 'postwave-jmap' ); ?></label>
          ...
          <div class="pw-form-actions">
            <button type="submit" class="pw-btn pw-btn-primary"><?php esc_html_e( 'Save account', 'postwave-jmap' ); ?></button>
            <button type="button" class="pw-btn pw-btn-outline" id="pw-account-form-cancel"><?php esc_html_e( 'Cancel', 'postwave-jmap' ); ?></button>
            <button type="button" class="pw-btn pw-btn-secondary" id="pw-test-account-btn"><?php esc_html_e( 'Test connection', 'postwave-jmap' ); ?></button>
      ...
      <p style="font-size:13px;color:var(--pw-muted,#787c82);margin-bottom:20px;">
        <?php esc_html_e( 'Routing rules are evaluated in order (first match wins). Each rule sends matching emails via the specified account. Rules are skipped if disabled or if their conditions do not match.', 'postwave-jmap' ); ?>
      </p>
      ...
      <div class="pw-empty-state">
        ...
        <p class="pw-empty-state__msg"><?php esc_html_e( 'No routing rules yet. Add a rule to route emails to different accounts based on recipient, subject, or plugin type.', 'postwave-jmap' ); ?></p>
      </div>
      <?php endif; ?>
      <?php if ( ! empty( $rules ) ) : ?>
      <div class="pw-panel" style="margin-bottom:20px;">
        <div class="pw-panel-body pw-panel-body-flush">
          <table class="pw-rules-table">
            <thead>
              <tr>
                <th><?php esc_html_e( 'Priority', 'postwave-jmap' ); ?></th>
                <th><?php esc_html_e( 'Rule name', 'postwave-jmap' ); ?></th>
                <th><?php esc_html_e( 'Conditions', 'postwave-jmap' ); ?></th>
                <th><?php esc_html_e( 'Account', 'postwave-jmap' ); ?></th>
                <th><?php esc_html_e( 'Enabled', 'postwave-jmap' ); ?></th>
                <th><?php esc_html_e( 'Actions', 'postwave-jmap' ); ?></th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr>
                <td>
                  <div class="pw-priority-btns">
                    ...
                    <form method="post" action="<?php echo $act; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>" style="display:inline">
                      ...
                      <?php endforeach; ?>
                      <button type="submit" title="<?php esc_attr_e( 'Move up', 'postwave-jmap' ); ?>">↑</button>
                    </form>
                    <?php else : ?>
                    ...
                    <form method="post" action="<?php echo $act; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>" style="display:inline">
                      ...
                      <input type="hidden" name="order[]" value="<?php echo esc_attr( $oid ); ?>">
                      <?php endforeach; ?>
                      <button type="submit" title="<?php esc_attr_e( 'Move down', 'postwave-jmap' ); ?>">↓</button>
                    </form>
                    <?php else : ?>
                    <button type="button" disabled>↓</button>
                    <?php endif; ?>
                ...
                <td class="pw-rule-conditions">
                  ...
                  <?php echo implode( ' <em>' . esc_html( isset( $rule['condition_operator'] ) && 'all' === $rule['condition_operator'] ? __( 'AND', 'postwave-jmap' ) : __( 'OR', 'postwave-jmap' ) ) . '</em> ', $cond_summary ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- array items built with esc_html() ?>
                  <?php else : ?>
                  <em><?php esc_html_e( 'All emails', 'postwave-jmap' ); ?></em>
                  <?php endif; ?>
                </td>
                <td><?php echo esc_html( $acct_name ); ?></td>
                <td>
                  <?php if ( ! empty( $rule['enabled'] ) ) : ?>
                  <span class="pw-badge--primary"><?php esc_html_e( 'Yes', 'postwave-jmap' ); ?></span>
                  <?php else : ?>
                  <span style="color:var(--pw-muted,#787c82);font-size:12px;"><?php esc_html_e( 'No', 'postwave-jmap' ); ?></span>
                  <?php endif; ?>
                </td>
                <td>
                  <div style="display:flex;gap:6px;">
                    ...
                    <form method="post" action="<?php echo $act; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>" style="display:inline;" onsubmit="return confirm('<?php echo esc_js( __( 'Delete this rule?', 'postwave-jmap' ) ); ?>')">
      ...
      <div style="margin-bottom:20px;">
        <button type="button" class="pw-btn pw-btn-primary" id="pw-add-rule-btn">
          + <?php esc_html_e( 'Add rule', 'postwave-jmap' ); ?>
        </button>
      </div>

      <!-- Add / Edit rule inline form -->
      <div class="pw-inline-form pw-hidden" id="pw-rule-form">
        <h3 id="pw-rule-form-title"><?php esc_html_e( 'Add rule', 'postwave-jmap' ); ?></h3>
        <form method="post" action="<?php echo $act; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>">
          ...
          <div class="pw-form-grid-2">
            <div class="pw-field">
              <label for="pw-rule-name"><?php esc_html_e( 'Rule name', 'postwave-jmap' ); ?></label>
              <input type="text" id="pw-rule-name" class="pw-input" name="pw_rule[name]" placeholder="<?php esc_attr_e( 'e.g. WooCommerce Orders', 'postwave-jmap' ); ?>">
            </div>
            <div class="pw-field" style="display:flex;align-items:center;gap:10px;padding-top:22px;">
              ...
              <span style="font-size:13px;color:var(--pw-text,#2c3338);"><?php esc_html_e( 'Enabled', 'postwave-jmap' ); ?></span>
            </div>
          </div>

          <!-- Condition operator -->
          <div class="pw-field" style="margin-top:16px;">
            <label><?php esc_html_e( 'Match operator', 'postwave-jmap' ); ?></label>
            <div style="display:flex;gap:20px;margin-top:6px;">
              <label style="display:flex;align-items:center;gap:6px;font-size:13px;cursor:pointer;">
                <input type="radio" name="pw_rule[condition_operator]" value="any" checked>
                <?php esc_html_e( 'Match ANY condition', 'postwave-jmap' ); ?>
              </label>
              <label style="display:flex;align-items:center;gap:6px;font-size:13px;cursor:pointer;">
                <input type="radio" name="pw_rule[condition_operator]" value="all">
                <?php esc_html_e( 'Match ALL conditions', 'postwave-jmap' ); ?>
              </label>
            </div>
          </div>
          ...
          <!-- Conditions -->
          <div class="pw-field" style="margin-top:16px;">
            <label><?php esc_html_e( 'Conditions', 'postwave-jmap' ); ?></label>
            <div class="pw-conditions-list" id="pw-conditions-list" style="margin-top:8px;"></div>
            <button type="button" class="pw-add-condition" id="pw-add-condition-btn">+ <?php esc_html_e( 'Add condition', 'postwave-jmap' ); ?></button>
            <p class="pw-desc" style="margin-top:6px;">
              <?php esc_html_e( 'Plugin values: ', 'postwave-jmap' ); ?>
          ...
          <div class="pw-form-grid-2" style="margin-top:16px;">
            <div class="pw-field">
              <label for="pw-rule-account"><?php esc_html_e( 'Target account', 'postwave-jmap' ); ?></label>
            ...
            <div class="pw-field">
              <label for="pw-rule-identity"><?php esc_html_e( 'Override identity ID', 'postwave-jmap' ); ?> <em class="pw-label-opt"><?php esc_html_e( 'optional', 'postwave-jmap' ); ?></em></label>
              <input type="text" id="pw-rule-identity" class="pw-input" name="pw_rule[identity_id]" placeholder="<?php esc_attr_e( 'Leave blank to use account default', 'postwave-jmap' ); ?>">
            </div>
          </div>

          <div class="pw-form-actions">
            <button type="submit" class="pw-btn pw-btn-primary"><?php esc_html_e( 'Save rule', 'postwave-jmap' ); ?></button>
            <button type="button" class="pw-btn pw-btn-outline" id="pw-rule-form-cancel"><?php esc_html_e( 'Cancel', 'postwave-jmap' ); ?></button>
          </div>
        </form>
      </div>
      ...
      <form method="post" action="<?php echo $act; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>">
        ...
        <div class="pw-panel">
          <div class="pw-panel-header">
            <h3><?php esc_html_e( 'Server Configuration', 'postwave-jmap' ); ?></h3>
            <p><?php esc_html_e( 'Your JMAP server URL, username, and password.', 'postwave-jmap' ); ?></p>
          </div>
          <div class="pw-panel-body">
            <div class="pw-field">
              <label for="pw-server-url"><?php esc_html_e( 'JMAP Server URL', 'postwave-jmap' ); ?></label>
              <input type="url" id="pw-server-url" class="pw-input" name="postwave[server_url]"
                value="<?php echo esc_attr( $o( 'server_url' ) ); ?>"
                placeholder="https://mail.example.com">
              <span class="pw-field-hint"><?php esc_html_e( 'Session is auto-discovered at /.well-known/jmap', 'postwave-jmap' ); ?></span>
            </div>
            <div class="pw-row-2">
              <div class="pw-field">
                <label for="pw-username"><?php esc_html_e( 'Username', 'postwave-jmap' ); ?></label>
                <input type="text" id="pw-username" class="pw-input" name="postwave[username]"
                  value="<?php echo esc_attr( $o( 'username' ) ); ?>" autocomplete="off">
              </div>
              <div class="pw-field">
                <label for="pw-password"><?php esc_html_e( 'Password', 'postwave-jmap' ); ?></label>
                <div class="pw-pass-wrap">
                  <input type="password" id="pw-password" class="pw-input" name="postwave[password]"
                    placeholder="<?php esc_attr_e( 'Leave blank to keep current', 'postwave-jmap' ); ?>"
                ...
                <span class="pw-field-hint pw-field-hint-ok">
                  ...
                  <?php esc_html_e( 'Password saved — leave blank to keep current', 'postwave-jmap' ); ?>
                </span>
                <?php endif; ?>
              </div>
            </div>
          ...
          <div class="pw-panel-footer">
            <button type="submit" class="pw-btn pw-btn-primary"><?php esc_html_e( 'Save credentials', 'postwave-jmap' ); ?></button>
          </div>
        </div>
        ...
        <div class="pw-panel">
          <div class="pw-panel-header">
            <h3><?php esc_html_e( 'Sender Identity', 'postwave-jmap' ); ?></h3>
            <p><?php esc_html_e( 'Choose which JMAP sending identity to use. Auto-resolve matches the From email to an identity on your server.', 'postwave-jmap' ); ?></p>
          </div>
          <div class="pw-panel-body">
            <div class="pw-field">
              <label class="pw-label" for="pw-identity-select"><?php esc_html_e( 'Identity', 'postwave-jmap' ); ?></label>
              <div class="pw-identity-wrap">
                <div class="pw-identity-controls">
                  <select id="pw-identity-select" name="postwave[identity_id]" class="pw-select pw-identity-dropdown">
                    <option value=""><?php esc_html_e( '— Auto-resolve (recommended) —', 'postwave-jmap' ); ?></option>
                    <?php
                  ...
                  <button type="button" id="pw-load-identities" class="pw-btn pw-btn--secondary pw-btn-secondary">
                    <?php esc_html_e( 'Load identities', 'postwave-jmap' ); ?>
                  </button>
                </div>
                <p class="pw-desc" style="margin-top:6px;"><?php esc_html_e( 'Click "Load identities" to fetch the list from your JMAP server. Save credentials on the Connection tab first.', 'postwave-jmap' ); ?></p>
                <p id="pw-identity-status" class="pw-desc pw-hidden" style="margin-top:4px;"></p>
              </div>
            </div>
          </div>
          <div class="pw-panel-footer">
            <button type="submit" class="pw-btn pw-btn-primary"><?php esc_html_e( 'Save identity', 'postwave-jmap' ); ?></button>
          </div>
        </div>
      </form>
      ...
      <div class="pw-panel pw-panel-test">
        <div class="pw-panel-header">
          <h3><?php esc_html_e( 'Test Connection', 'postwave-jmap' ); ?></h3>
          <p><?php esc_html_e( 'Save your credentials first, then verify the server responds correctly.', 'postwave-jmap' ); ?></p>
        </div>
        <div class="pw-panel-body">
          <div class="pw-test-actions">
            <button type="button" class="pw-btn pw-btn-secondary" id="pw-test-conn">
              ...
              <?php esc_html_e( 'Test connection', 'postwave-jmap' ); ?>
            </button>
            <button type="button" class="pw-btn pw-btn-secondary" id="pw-test-email">
              ...
              <?php esc_html_e( 'Send test email', 'postwave-jmap' ); ?>
            </button>
          </div>
          ...
          <div id="pw-steps" style="display:none">
            <div class="pw-step-row" id="pw-step-discover">
              ...
              <span><?php esc_html_e( 'Discovering JMAP session…', 'postwave-jmap' ); ?></span>
            </div>
            <div class="pw-step-row pw-step-row--pending" id="pw-step-identity">
              <span class="pw-step-dot">○</span>
              <span><?php esc_html_e( 'Resolving sender identity…', 'postwave-jmap' ); ?></span>
            </div>
            <div class="pw-step-row pw-step-row--pending" id="pw-step-done">
              <span class="pw-step-dot">○</span>
              <span><?php esc_html_e( 'Verifying capabilities…', 'postwave-jmap' ); ?></span>
            </div>
          </div>
      ...
      <div class="pw-panel">
        <div class="pw-panel-header pw-panel-header-row">
          <div>
            <h3><?php esc_html_e( 'Mail Log', 'postwave-jmap' ); ?></h3>
            <p><?php esc_html_e( 'Last 100 send attempts. Bodies are never stored.', 'postwave-jmap' ); ?></p>
          </div>
          ...
          <div style="display:flex;gap:8px;align-items:center;flex-shrink:0;">
            <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" style="display:inline;">
              ...
              <button type="submit" class="pw-btn pw-btn-secondary pw-btn--sm">
                &#8595; <?php esc_html_e( 'Export CSV', 'postwave-jmap' ); ?>
              </button>
            </form>
            <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" style="display:inline;">
              ...
              <button type="submit" class="pw-btn pw-btn-danger pw-btn--sm"
                onclick="return confirm('<?php echo esc_js( __( 'Clear all log entries? This cannot be undone.', 'postwave-jmap' ) ); ?>')">
                ...
                <?php esc_html_e( 'Clear log', 'postwave-jmap' ); ?>
              </button>
            </form>
          </div>
          <?php endif; ?>
        ...
        <div class="pw-panel-body pw-panel-body-flush">
          ...
          <div class="pw-empty-state">
            ...
            <h4><?php esc_html_e( 'No emails logged yet', 'postwave-jmap' ); ?></h4>
            <p><?php esc_html_e( 'Sent and failed emails will appear here once Postwave is active.', 'postwave-jmap' ); ?></p>
          </div>
          <?php else : ?>
          <div class="pw-table-scroll">
            <table class="pw-table">
              <thead>
                <tr>
                  <th><?php esc_html_e( 'Status', 'postwave-jmap' ); ?></th>
                  <th><?php esc_html_e( 'Date / Time', 'postwave-jmap' ); ?></th>
                  <th><?php esc_html_e( 'To', 'postwave-jmap' ); ?></th>
                  <th><?php esc_html_e( 'Subject', 'postwave-jmap' ); ?></th>
                  <th title="<?php esc_attr_e( 'When the recipient opened this email (requires open tracking to be enabled)', 'postwave-jmap' ); ?>"><?php esc_html_e( 'Opened', 'postwave-jmap' ); ?></th>
                  <th><?php esc_html_e( 'Details', 'postwave-jmap' ); ?></th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr>
                  <td>
                    <span class="pw-badge-pill pw-badge-pill-<?php echo $sent ? 'success' : 'danger'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>">
                      <?php echo $sent ? esc_html__( 'Sent', 'postwave-jmap' ) : esc_html__( 'Failed', 'postwave-jmap' ); ?>
                    </span>
                    <?php if ( 'retried' === $retry_status ) : ?>
                    <span class="pw-badge pw-badge--retried" title="<?php esc_attr_e( 'Sent via retry queue', 'postwave-jmap' ); ?>">
                      <?php echo esc_html( sprintf(
                        /* translators: %d: number of retries */
                        _n( 'retry %d', 'retry %d', (int) ( $e['retry_count'] ?? 1 ), 'postwave-jmap' ),
                        (int) ( $e['retry_count'] ?? 1 )
                      ) ); ?>
                    </span>
                    <?php elseif ( 'exhausted' === $retry_status ) : ?>
                    <span class="pw-badge pw-badge--exhausted" title="<?php esc_attr_e( 'All retry attempts exhausted', 'postwave-jmap' ); ?>">
                      <?php esc_html_e( 'exhausted', 'postwave-jmap' ); ?>
                    </span>
                    <?php endif; ?>
                  </td>
                  ...
                  <td class="pw-td-opened">
                    ...
                    <?php else : ?>
                    <span class="pw-opened-no" title="<?php esc_attr_e( 'Not yet opened, or open tracking is disabled', 'postwave-jmap' ); ?>">—</span>
                    <?php endif; ?>
                  </td>
                  <td class="pw-td-detail">
                    <button type="button" class="pw-detail-btn"><?php esc_html_e( 'Details', 'postwave-jmap' ); ?> ▾</button>
                    <dl class="pw-detail-panel" style="display:none">
                      <?php if ( ! empty( $e['from'] ) ) : ?>
                      <div><dt><?php esc_html_e( 'From', 'postwave-jmap' ); ?></dt><dd><code><?php echo esc_html( $e['from'] ); ?></code></dd></div>
                      <?php endif; ?>
                      <?php if ( ! empty( $e['account_id'] ) ) : ?>
                      <div><dt><?php esc_html_e( 'Account', 'postwave-jmap' ); ?></dt><dd><code><?php echo esc_html( $e['account_id'] ); ?></code></dd></div>
                      <?php endif; ?>
                      <?php if ( ! empty( $e['identity_id'] ) ) : ?>
                      <div><dt><?php esc_html_e( 'Identity', 'postwave-jmap' ); ?></dt><dd><code><?php echo esc_html( $e['identity_id'] ); ?></code></dd></div>
                      <?php endif; ?>
                      <?php if ( ! empty( $e['email_id'] ) ) : ?>
                      <div><dt><?php esc_html_e( 'Email ID', 'postwave-jmap' ); ?></dt><dd><code><?php echo esc_html( $e['email_id'] ); ?></code></dd></div>
                      <?php endif; ?>
                      <?php if ( ! empty( $opened_at ) ) : ?>
                      <div><dt><?php esc_html_e( 'Opened', 'postwave-jmap' ); ?></dt><dd><?php echo esc_html( wp_date( 'Y-m-d H:i:s', (int) $opened_at ) ); ?></dd></div>
                      <?php endif; ?>
                      <?php if ( ! empty( $e['error'] ) ) : ?>
                      <div class="pw-detail-error"><dt><?php esc_html_e( 'Error', 'postwave-jmap' ); ?></dt><dd><?php echo esc_html( $e['error'] ); ?></dd></div>
                      <?php endif; ?>
                    </dl>
                  </td>
                </tr>
